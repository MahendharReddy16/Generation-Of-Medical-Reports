...
def predict(img_1,img_2):
    ...
    ''' this function takes the image paths and and plots the images and 
      feeds to beam search function to generate output sequence'''
...
def score(img_1,img_2,report):
    '''This function takes the image paths as input and generates ouput sequence and calculates the bleu score for it'''
    result = predict(img_1,img_2)
    result_ref = result.split() 
    actual = str(report)
    actual_ref = set(actual.split())
